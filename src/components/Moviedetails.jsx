				...
				<div className=" flex">
					...
					<div className="pl-[5%]">
						...
						<div className="flex gap-4 items-center">
							...
							<p className=" text-xl font-black break-words w-[5vw]">
								User Score
							</p>
						...
						<h1 className="font-semibold text-lg">
							<i>{info.detail.tagline}</i>
						</h1>

						<h1 className="text-lg font-bold">Overview</h1>
						<p className=" max-w-[70vw] px-[2%]">
						...
						<Link
							...
							className="px-5 py-2 bg-[#6556CD] font-bold rounded-md"
						>
							<i className="ri-arrow-right-s-fill text-xl mr-2"></i>
							Play Trailer
						</Link>
					</div>
				</div>
				...
				<div className="flex flex-col gap-3 pl-[7%] py-[3%]">
					...
					{info.watchproviders &&
						info.watchproviders.flatrate && (
							<div className="flex items-center">
								<h1 className="font-medium w-[12vh]">
									Flatrate
								</h1>
